    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/board/**", "/api/v1/user/**", "/api/v1/category/**").permitAll()
                        .requestMatchers("/api/v1/category/register", "/api/v1/category/update/**", "/api/v1/category/delete/**").hasRole("ADMIN")
